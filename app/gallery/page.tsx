...
export default async function Gallery() {
  ...
  return (
    <div style={{ paddingTop: '64px' }}>
      <section style={{ background: "linear-gradient(rgba(76,14,26,0.72), rgba(76,14,26,0.84)), url('/assests/laykay08.jpeg') center/cover", padding: '100px 32px', textAlign: 'center' }}>
        <Reveal>
